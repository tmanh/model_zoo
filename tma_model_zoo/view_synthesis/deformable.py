...
class DeformableNetwork(DeformableModule):
    ...
    def blending(self, deep_image, valid_mask, offsets, projected_colors, enhanced_colors, n_samples, n_views, height, width):
        ...
        # return (deformable_output, deep_image, enhanced_colors.view(n_samples, n_views, -1, height, width)), valid_mask
        # return (deformable_output,enhanced_colors.view(n_samples, n_views, -1, height, width),projected_colors.view(n_samples, n_views, -1, height, width)), valid_mask
